...
class ExportListOfMaterialSuppliedService {
    ...
    def getFormatters(){
        ...
        Map formatters = ["specimen.participant.studySubject.studySubjectIdentifier": gelId, "specimen.anatomicalSite": anatomicalSite, "exhausted":exhausted,
                          "gelSuitabilityReport.suitableForGel":suitableForGel]
        return formatters
    }
    ...
    def getFields(){
        List fields = ["specimen.participant.studySubject.studySubjectIdentifier", "specimen.anatomicalSite", "aliquotType", "blockNumber", "aliquotRanking",
                       "aliquotVolumeMass", "unit", "exhausted", "gelSuitabilityReport.suitableForGel"]
        return fields
    }
    ...
    def getParameters(){
        Map parameters = [title: "Exported Material Supplied", "column.widths": [0.2, 0.15, 0.25, 0.15, 0.15, 0.1, 0.1, 0.1, 0.2]]
        return parameters
    }
}
