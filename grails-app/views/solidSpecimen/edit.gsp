...
<body>
	...
	<section id="edit-solidSpecimen" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${solidSpecimenInstance?.id}" />
			<g:hiddenField name="version" value="${solidSpecimenInstance?.version}" />
