            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="${hasErrors(bean: solidSpecimenInstance, field: 'participant', 'error')} required" >
                        ...
                        <div>
                            <g:select class="form-control" id="participant" name="participant.id" from="${listParticipantByGeLId}" optionKey="id" required="" value="${solidSpecimenInstance?.participant?.id}" />
