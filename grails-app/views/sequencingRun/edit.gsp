...
<body>
	...
	<section id="edit-sequencingRun" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${sequencingRunInstance?.id}" />
			<g:hiddenField name="version" value="${sequencingRunInstance?.version}" />
