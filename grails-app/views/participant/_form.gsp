...
<div class="row">
    ...
    <div class="col-lg-6">
			...
			<div class="${hasErrors(bean: participantInstance, field: 'dateOfBirth', 'error')} ">
				...
				<div>
					<bs:datePicker name="dateOfBirth" precision="day"  value="${participantInstance?.dateOfBirth}" default="none" noSelection="['': '']" />
...
<div class="row">
    ...
    <div class="col-lg-6">
			<div class="${hasErrors(bean: participantInstance, field: 'diagnosis', 'error')} ">
				<label for="diagnosis" class="control-label"><g:message code="participant.diagnosis.label" default="Diagnosis" /></label>
				<div>
					<g:textField class="form-control" name="diagnosis" value="${participantInstance?.diagnosis}"/>
