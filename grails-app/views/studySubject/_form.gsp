<%@ page import="geldb.StudySubject" %>
			...
			<div class="${hasErrors(bean: studySubjectInstance, field: 'study', 'error')} required">
				...
				<div>
					<g:select class="form-control" id="study" name="study.id" from="${geldb.Study.list()}" optionKey="id" required="" value="${studySubjectInstance?.study?.id}" class="many-to-one"/>
    ...
    <div class="row">
        <div class="col-lg-6">
			<div class="${hasErrors(bean: studySubjectInstance, field: 'studySubjectIdentifier', 'error')} required">
				<label for="studySubjectIdentifier" class="control-label"><g:message code="studySubject.studySubjectIdentifier.label" default="Study Participant Identifier" /><span class="required-indicator">*</span></label>
				<div>
...
<div class="row">
    <div class="col-lg-6">
			<div class="${hasErrors(bean: studySubjectInstance, field: 'recruitedBy', 'error')} ">
				...
				<div>
					<g:textField class="form-control" name="recruitedBy" maxlength="50" value="${studySubjectInstance?.recruitedBy}"/>
    ...
    <div class="col-lg-6">
			<div class="${hasErrors(bean: studySubjectInstance, field: 'consentFormVersion', 'error')} required">
				...
				<div>
					<g:textField class="form-control" name="consentFormVersion" maxlength="50" required="" value="${studySubjectInstance?.consentFormVersion}"/>
