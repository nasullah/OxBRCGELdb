...
<body>
	...
	<section id="edit-gelSuitabilityReport" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${gelSuitabilityReportInstance?.id}" />
			<g:hiddenField name="version" value="${gelSuitabilityReportInstance?.version}" />
