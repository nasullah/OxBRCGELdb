        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="${hasErrors(bean: locationInstance, field: 'locationName', 'error')} ">
                    ...
                    <div>
                        <g:textField class="form-control" name="locationName" value="${locationInstance?.locationName}"/>
            ...
            <div class="col-lg-6">
                <div class="${hasErrors(bean: locationInstance, field: 'locationDescription', 'error')} ">
                    <label for="locationDescription" class="control-label"><g:message code="location.locationDescription.label" default="Location Description" /></label>
                    <div>
                        <g:textField class="form-control" name="locationDescription" value="${locationInstance?.locationDescription}"/>
