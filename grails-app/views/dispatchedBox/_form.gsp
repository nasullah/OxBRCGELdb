<%@ page import="geldb.DispatchedBox" %>
        ...
        <p><b>Dispatch Record- ${dispatchedBoxInstance?.dispatchRecord}</b></p>
        <g:hiddenField id="dispatchRecord" name="dispatchRecord.id"  value="${dispatchedBoxInstance?.dispatchRecord?.id}"/>
