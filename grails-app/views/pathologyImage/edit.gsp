...
<body>
	...
	<section id="edit-pathologyImage" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${pathologyImageInstance?.id}" />
			<g:hiddenField name="version" value="${pathologyImageInstance?.version}" />
