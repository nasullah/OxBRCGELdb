            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="${hasErrors(bean: sampleTrackingEventInstance, field: 'sampleTrackingEventType', 'error')} required">
                        ...
                        <div>
                            <g:select class="form-control" id="sampleTrackingEventType" name="sampleTrackingEventType.id" from="${geldb.SampleTrackingEventType.findAllBySampleTrackingEventTypeName('Received at Oxford')}"
...
<script>
    function getSpecimen(){
        ${remoteFunction (controller: 'sampleTrackingEvent',
                        action: 'findReceivedSpecimenByGeLId',
