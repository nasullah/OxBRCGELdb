...
<body>
	...
	<section id="edit-previousTreatment" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${previousTreatmentInstance?.id}" />
			<g:hiddenField name="version" value="${previousTreatmentInstance?.version}" />
