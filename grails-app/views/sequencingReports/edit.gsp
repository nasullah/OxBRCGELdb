...
<body>
	...
	<section id="edit-sequencingReports" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${sequencingReportsInstance?.id}" />
			<g:hiddenField name="version" value="${sequencingReportsInstance?.version}" />
