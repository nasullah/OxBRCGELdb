            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="${hasErrors(bean: aliquotInstance, field: 'specimen', 'error')} required">
                        ...
                        <div>
                            <g:select class="form-control" id="specimen" name="specimen.id" size="5" from="${listSpecimenByGeLId}" optionKey="id" onchange="exhaustFluidSpecimen()" onclick="preFillCreatedOn()()" required="" value="${aliquotInstance?.specimen?.id}" class="many-to-one"/>
