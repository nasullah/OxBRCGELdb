...
<body>
	...
	<section id="edit-sampleTrackingEventType" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${sampleTrackingEventTypeInstance?.id}" />
			<g:hiddenField name="version" value="${sampleTrackingEventTypeInstance?.version}" />
